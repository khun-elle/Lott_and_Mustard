...
kbl(rollout, col.names = c("State", "Year First Treated"), caption = "**Table 1: A Table of Rollout State By State", format_caption = c("italic", "underline")) %>% kable_styling(bootstrap_options = "striped", full_width = F)
```
</div>
